<?php
    ...
    $booking = $conn->query("SELECT * FROM num_book WHERE studen_id = $studen_id AND num_status = 1")->num_rows;
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<?php
    if (isset($_SESSION['studen_id'])) {
        echo "
            <div class='profile'>
                <div class='img-p'>
                    <img src='../../IMG/studen/$studen_key.JPG' alt=''>
                </div>
                <div class='title'>
                    <h1>$studen_name</h1>
                    <div class='point'>
...
?>
            <div class="menu">
                <ul class="main">
                    ...
                    <a href="user.php"><li><i class="bi bi-person"></i> บัญชีผู้ใช้</li></a>
                </ul>
                <ul class="secondary">
                    <h1>data</h1>
                    <a href="#"><li><i class="bi bi-journal-text"></i> เข้าใช้ห้องสมุด <p><?php echo $record_total?></p></li></a>
                    <a href="#"><li><i class="bi bi-bookmark"></i> กำลังยืมอยู่ <p><?php echo $booking?></p></li></a>
                    <a href="#"><li><i class="bi bi-bookmark"></i> เคยยืมทั้งหมด <p><?php echo $studen_booked_total?></p></li></a>
                </ul>
                <ul class="login">
